...
def main():
    ...
    try:
        ...
        if not dataset_image_paths:
            print(f"No training images found in project '{args.project}'.")
            print("Please add images to the 'training' folder to manage them.")
            return
        ...
        print("Please make sure you have added the reference color checker image to the 'dataset/colorchecker' directory")
        print("and updated the 'project_config.json' file with the correct path.")
